...
namespace API.Controllers
{
    public class ProfilesController : BaseApiController
    {
        ...
        public async Task<IActionResult> GetUserActivities(string userId, string filter) => HandleResult(await Mediator.Send(new GetUserActivities.Query { UserId = userId, Filter = filter }));
    }
}
